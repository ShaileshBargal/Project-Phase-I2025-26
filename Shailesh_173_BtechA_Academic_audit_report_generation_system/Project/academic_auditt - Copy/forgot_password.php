        ...
        if (!$stmt) {
            ...
            if ($res && $res->num_rows === 1) {
                ...
                try {
                    ...
                    $mail->SMTPAuth   = true;
                    $mail->Username   = 'shaileshbargal19@gmail.com';
                    $mail->Password   = 'nrhtsgmmwwflaelx'; // your existing 16-char App Password
                    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                    $mail->Port       = 587;

                    // Optional but recommended to avoid SSL verification issues
                    $mail->SMTPOptions = [
                        'ssl' => [
                            'verify_peer'       => false,
                    ...
                    // Optional debugging — uncomment during testing
                    // $mail->SMTPDebug = 2;
                    // $mail->Debugoutput = 'html';

                    $mail->setFrom('shaileshbargal19@gmail.com', 'Academic Audit System');
